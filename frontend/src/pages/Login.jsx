...
import { Eye, EyeOff, Building2, Mail, Lock, ArrowRight, Bug } from 'lucide-react'
import Button from '../components/ui/Button'
import Input from '../components/ui/Input'
import { runAllTests } from '../utils/firebaseDebugger'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        {/* Firebase Diagnostic Tool - Remove after fixing */}
        <div className="mb-8">
          <FirebaseDiagnostic />
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-secondary-600">Sign in to your Gov CSR Portal account</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="w-full inline-flex justify-center py-2 px-4 border border-secondary-300 rounded-lg shadow-sm bg-white text-sm font-medium text-secondary-500 hover:bg-secondary-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              {loading ? (
          ...
          {/* Firebase Debug Button - Remove after fixing */}
          <div className="mt-4 text-center">
            <button
              onClick={handleFirebaseTest}
              className="inline-flex items-center px-3 py-2 text-xs text-secondary-500 hover:text-secondary-700 transition-colors"
            >
